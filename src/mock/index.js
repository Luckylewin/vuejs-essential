...
Mock.mock('/users/active', 'get', () => {
    ...
    articles.map((article) => {
        ...
        // 合并评论 等价于 comments = comments.concact(articleComments)
...
Mock.mock('/articles/hot', 'post', (options) => {
    // 将评论最少文章排在前面
    let filteredArticles = store.getters.getArticlesByFilter('noreplay')
    // 将评论最多的文章排在前面
