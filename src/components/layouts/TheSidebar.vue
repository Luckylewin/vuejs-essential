        ...
        <div class="other">
            ...
            <div class="panel panel-default corner-radius">
                <div class="panel-body text-center">
                    <a href="mailto:876505905@qq.com" style="color:#a5a5a5">
...
export default {
    ...
    data() {
        return {
            ...
            resources: [
                ...
                {
                    title: 'Vue 菜鸟教程',
                    link: 'http://www.runoob.com/vue2/vue-tutorial.html'
                },
                {
    ...
    // 在示例创建完成后
    created() {
        // 通过 axios 执行GET请求来返回活跃用户
        this.$axios.get('/users/active').then((response) => {
            // 在成功的回调里, 从response.data 获取返回数据
