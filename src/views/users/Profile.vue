<template>
    <div class="col-md-9 left-col">
        <div class="panel panel-default padding-md">
            ...
            <hr>
            <div class="form-horizontal" id="data-validator-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <label class="checkbox-inline">
                            <input v-model="hobbies" value="学习" type="checkbox"> 学习
                        </label>
                        <label class="checkbox-inline">
                            <input v-model="hobbies" value="运动" type="checkbox"> 运动
                        </label>
                        <label class="checkbox-inline">
                            <input v-model="hobbies" value="音乐" type="checkbox"> 音乐
                        </label>
                        <label class="checkbox-inline">
                            <input v-model="hobbies" value="游戏" type="checkbox"> 游戏
                        </label>
                         <label class="checkbox-inline">
                            <input v-model="hobbies" value="旅行" type="checkbox"> 旅行
                        </label>
                    </div>    
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea v-model.trim="introduction" class="form-control introduce" ></textarea>
                    </div>
                </div>
